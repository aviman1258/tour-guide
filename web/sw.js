...
const SHELL_VERSION = "v29"; // bump on every deploy that changes web/ — the shell is cache-first
...
const SHELL_FILES = [
  ...
  "./js/storage.js", "./js/drivePrep.js", "./js/drive.js", "./js/geofence.js", "./js/speech.js", "./js/sim.js", "./js/busy.js", "./js/typeahead.js", "./js/timings.js", "./js/ping.js", "./js/secretPrompt.js", "./js/turnVoice.js",
